...
class CategoryCubit extends Cubit<CategoryState> {
  ...
  void createListCategory() async {
    try {
      ...
      // phát tín hiệu tới UI lấy dữ liệu thành công
      emit(CategoryGetSuccessState());
    } catch (e) {
      // phát tín hiệu tới UI lấy dữ liệu thất bại
...
const jsonCategory = [
  ...
  {
    "Name": "Phụ kiện",
    "UrlPicture": "https://thoxe.vn/wp-content/uploads/2019/08/Web_Icon",
    "ID": 259
  },
  {
    "Name": "Hoá mỹ phẩm",
  ...
  },
  {
    "Name": "Thực phẩm",
    "UrlPicture":
        "http://ptdtnttinhquangninh.edu.vn/wp-content/uploads/2018/08/Photo-basket-icon-300x295",
    "ID": 266
  },
  {
    "Name": "Đồ uống",
